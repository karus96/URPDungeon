...
namespace FIMSpace.Graph
{
    public abstract partial class FGraphDrawerBase
    {
        ...
        protected virtual void DisplayGraphBody()
        {
            ...
            eventMousePosOffsetted.y -= graphTopMarginOffset;
            ...
            graphDisplayRect = new Rect(displayPadding.x, graphTopMarginOffset + displayPadding.y, position.width - displayPadding.z, (position.height - graphTopMarginOffset) - displayPadding.w);
        ...
        {
            Rect headerRect = new Rect(0f, graphTopMarginOffset, graphDisplayRect.width, 24);
