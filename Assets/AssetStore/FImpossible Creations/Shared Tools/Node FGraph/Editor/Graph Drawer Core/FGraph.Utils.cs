...
namespace FIMSpace.Graph
{
    public abstract partial class FGraphDrawerBase
    {
        ...
        public virtual void ResetGraphPosition()
        {
            ...
            graphDisplayOffset.y -= graphTopMarginOffset * 0.5f;
        ...
        public virtual void ClampGraphPosition()
        {
            ...
            if (graphDisplayOffset.y - (position.height - graphTopMarginOffset) / graphZoom < -clampAreaSize.y) { graphDisplayOffset.y = Mathf.Min(-GraphSize.y + (position.height - graphTopMarginOffset) / graphZoom, 0f); }
        }
