...
namespace FIMSpace.Generating.Planning
{
    ...
    public partial class FieldPlanner : ScriptableObject, IPlanNodesContainer
    {
        ...
        public List<PlannerRuleBase> FProcedures = new List<PlannerRuleBase>();
        public List<PlannerRuleBase> FPostProcedures = new List<PlannerRuleBase>();
        ...
        public List<PlannerRuleBase> Procedures { get { return FProcedures; } }

        public List<PlannerRuleBase> PostProcedures { get { return FPostProcedures; } }
        ...
        public void PrepareProcedures()
        {
            for (int i = 0; i < FProcedures.Count; i++)
            {
                ...
                FProcedures[i].PreGeneratePrepare();
            }
            ...
            for (int i = 0; i < FPostProcedures.Count; i++)
            {
                ...
                FPostProcedures[i].PreGeneratePrepare();
            }
        }
        ...
        internal void PrePrepareForGenerating(int indexOnPreset, int preparationIndex)
        {
            ...
            for (int p = 0; p < Procedures.Count; p++)
            {
                Procedures[p].ParentPlanner = this;
            }

            for (int p = 0; p < PostProcedures.Count; p++)
            {
                PostProcedures[p].ParentPlanner = this;
            }
