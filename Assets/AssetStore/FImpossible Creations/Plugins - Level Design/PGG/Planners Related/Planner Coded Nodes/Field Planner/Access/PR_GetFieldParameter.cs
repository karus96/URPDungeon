        ...
        public override void OnStartReadingNode()
        {
            ...
            if (planner)
            {
                switch (OutputParam)
                {
                    ...
                    case EPlannerParam.InstancesCount: if (planner.LatestResult != null) if (planner.IsDuplicate) { OutParam.Variable.SetValue(planner.DuplicateParent.Instances); } else { OutParam.Variable.SetValue(planner.Instances); } break;
                }
            }
        }
