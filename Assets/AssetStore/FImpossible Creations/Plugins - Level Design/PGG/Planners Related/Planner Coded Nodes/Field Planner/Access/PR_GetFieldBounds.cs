...
namespace FIMSpace.Generating.Planning.PlannerNodes.Field.Access
{
    ...
    public class PR_GetFieldBounds : PlannerRuleBase
    {
        ...
        public override string GetNodeTooltipDescription { get { return "Get bounds parameters of choosed field"; } }
        ...
        public override Vector2 NodeSize { get { return new Vector2(210, _EditorFoldout ? 240 : 142); } }
        ...
        [Port(EPortPinType.Output, EPortValueDisplay.NotEditable)] public PGGVector3Port Min;
        [Port(EPortPinType.Output, EPortValueDisplay.NotEditable)] public PGGVector3Port Max;
