...
namespace FIMSpace.Generating.Planning.PlannerNodes.Cells.Actions
{
    ...
    public class PR_GetNearestCell : PlannerRuleBase
    {
        ...
        //[HideInInspector] [Port(EPortPinType.Input)] public BoolPort FindCentered;
        ...
        public override void OnStartReadingNode()
        {
            ...
            NearestACell.ProvideFullCellData(chA.GetNearestCellTo(chB), chA, fieldA.LatestResult);
        ...
        public override void Editor_OnNodeBodyGUI(ScriptableObject setup)
        {
            ...
            //{
            //    GUILayout.Space(4);
            //    if (sp == null) sp = baseSerializedObject.FindProperty("FindCentered");
