        ...
        public void ApplyOverridesOf(FieldModification mod, ModOverrideHelper overrides)
        {
            if (mod.DrawSetupFor == FieldModification.EModificationMode.CustomPrefabs)
            {
                ...
                else
                {
                    ...
                    {
                        if (overrides.OverridePrefabs[o].Prefab == null) { continue; }
                        mod.PrefabsList[o].Prefab = overrides.OverridePrefabs[o].Prefab;
                        mod.PrefabsList[o].MainCollider = overrides.OverridePrefabs[o].MainCollider;
                    }
                }
            }
